      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <Image
              ...
              src={require("@/public/images/team/1.svg")}
              alt="Person"
              width={100}
              height={100}
            />
            <div
              className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300  bg-opacity-75 opacity-0 hover:opacity-100"
              style={{
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundImage = `url("/images/team/bg.svg")`;
              }}
              onMouseLeave={(e) => {
        ...
        <div className="lg:mt-10">
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <Image
              className="object-cover w-full h-56 md:h-64 xl:h-[17rem]"
              src={require("@/public/images/team/2.svg")}
              alt="Person"
              width={100}
              height={100}
            />
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <Image
              className="object-cover w-full h-56 md:h-64 xl:h-[17rem]"
              src={require("@/public/images/team/3.svg")}
              alt="Person"
              width={100}
              height={100}
            />
