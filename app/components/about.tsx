...
export default function About() {
  ...
  return (
    <section className="about my-[80px] relative">
      <div className="bg-[#dbd7fb] absolute top-[15rem] -z-20 left-[-35rem] h-[15rem] w-[24rem] rounded-full blur-[4rem] sm:w-[36.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394] dark:blur-[11rem]"></div>
      <div className="bg-[#fbe2e3] absolute top-[16rem] -z-10 left-[1rem] h-[25.25rem] w-[25.25rem] rounded-full blur-[4rem] sm:w-[36.75rem] dark:bg-[#946263] dark:blur-[11rem]"></div>
